<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="media_aluno.aspx.cs" Inherits="M6_TrabalhoModelo_T2.Consultas.media_aluno" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <asp:SqlDataSource runat="server" ID="SqlMedia" ConnectionString='<%$ ConnectionStrings:ConnectionString_Notas_T2 %>' SelectCommand="SELECT alunos.nome, AVG(notas.valor_nota) AS Média FROM alunos INNER JOIN notas ON alunos.nprocesso = notas.nprocesso GROUP BY notas.nprocesso, alunos.nome"></asp:SqlDataSource>
        </div>
    </form>
            <!--JS-->
